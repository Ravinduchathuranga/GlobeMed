...
public class PaymentDto {
    ...
    private String payment_date; // keep as String to match entity
    private PaymentTypes method;
    private PaymentStatus status;

    public PaymentDto() {}

    public PaymentDto(String payment_id, String patient_id, String appointment_id, double amount, String payment_date, PaymentTypes method, PaymentStatus status) {
